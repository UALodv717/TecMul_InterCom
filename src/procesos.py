...
class Processing:
    ...
    def call_temporal_script(self, quant, wavelet, level, output_file):
        """
        ...
        for wavelet in processor.wavelets:
            ...
            for level in processor.levels:
                if int(level) > max_level:
                    continue  # Skip levels beyond the max supported for this wavelet
                
                # Generate a unique output file for each valid combination
                ...
                # Call the script for this combination
                processor.call_temporal_script(quant, wavelet, level, output_file)
