...
class advancedThreshold(Threshold):
    ...
    def create_ToH_curve_data(self, freq_steps=1000, volume_steps=0.1):
        ...
        for freq in np.arange(20, 22101, freq_steps):
    ...
    def recive_ToH_data(self, freq_volume):
        '''recive the ToH data dictionary by TCP connection'''
        pass
...
if __name__ == "__main__":
    ...
    if minimal.args.createToH or minimal.args.createToHCumulative:
        saltos = 20000 / 2 ** int( minimal.args.levels)
        print(intercom.create_ToH_curve_data(saltos))
